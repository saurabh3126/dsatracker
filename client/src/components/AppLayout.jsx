...
export default function AppLayout() {
  ...
  return (
    <div
      className={(isAdd ? 'dsa-bg-add' : 'dsa-bg') + ' min-h-screen bg-gradient-to-b from-slate-950 via-slate-950 to-slate-900'}
    >
      <Navbar />
      <main className={isHome ? 'pb-0' : 'pb-16'}>
        <Outlet />
      </main>
      
      <footer className="border-t border-white/5 bg-[#05070a]/50 py-12 backdrop-blur-xl">
