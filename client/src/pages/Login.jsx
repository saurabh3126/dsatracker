...
export default function Login() {
  ...
  return (
    <div className="mx-auto w-full max-w-md px-4 py-12 text-slate-100">
      ...
      <p className="mt-2 text-sm text-slate-300">Email + password only. Usernames are collected at signup.</p>
      ...
      <form onSubmit={onSubmit} className="mt-8 space-y-4 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <button
          ...
          className={
            ...
            (loading ? 'cursor-not-allowed bg-white/5 text-slate-300' : 'bg-indigo-500/20 text-indigo-100 hover:bg-indigo-500/30')
          }
        >
        ...
        <div className="text-center text-sm text-slate-300">
          ...
          <Link to="/signup" className="text-indigo-200 hover:text-indigo-100">
            Sign up
          </Link>
        </div>
      </form>
